...
const panelRoutes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'DeleteAlbum/:id', component: DeleteAlbumComponent },
            { path: 'DeletePhotoAlbum/:id', component: DeletePhotoAlbumComponent },
            { path: 'ListPhotoAlbum/:id', component: ListPhotoAlbumComponent }
        ]
